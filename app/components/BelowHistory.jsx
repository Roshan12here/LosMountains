...
const BelowHistory = () => {
  return (
    <div className="padding-container max-container w-full ">
      ...
      <div className="flex  gap-5 lg:gap-10 w-[100%] sm:w-[80%]  md:w-[100%] lg:w-[70%] xl:w-[70%] 2xl:w-[60%] mx-auto ">
      <h1 className='text-8xl sblue wsmoke  md:text-[10rem] lg:text-[14rem] pt-[-2vh] mt-[2vh] xl:text-[12rem] 2xl:text-[12rem]'>
  02. 
</h1>
<h2 className='text-[3.6rem] sm:text-[2rem]  md:text-[2rem] lg:text-[3rem] xl:text-[3rem] mt-[3vh]  sm:mt-[3vh] md:mt-[6vh] lg:mt-[8vh] xl:mt-[8.9vh] 2xl-[10vh] ml-[14vw] sm:ml-[1vw] md:ml-[-4.2vw] lg:ml-[-5.8vw] sl:ml-[-5.8vw] 2xl:ml-[-5.8vw]  History  font-extrabold'>CLimb</h2>
